...
<body>
	...
	<div class="w3-main" style="margin-left: 300px">
		...
		<tr>
			<td>${requestScope.selectCountry.countryIdx}</td>
			<td>${requestScope.selectCountry.name}</td>
			<td>${requestScope.selectCountry.imgPath}</td>
			<td>${requestScope.selectCountry.info}</td>
		</tr>
		</table>
		</article>
		<!-- About section -->
